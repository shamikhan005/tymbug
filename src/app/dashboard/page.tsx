  ...
  return (
    <div className="max-w-5xl mx-auto p-6 sm:p-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-semibold text-gray-800">Webhook History</h1>
      ...
      {webhooks.length === 0 ? (
        <div className="text-center py-12 text-gray-500">No webhooks received yet</div>
      ) : (
              ...
              <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-gray-500">{new Date(webhook.receivedAt).toLocaleString()}</span>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 font-mono">{webhook.id}</span>
                  <svg
